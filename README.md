...
сервер принимает данные, включенные в тело сообщения запроса, и отправляет их 
на обработку приложению, указанному как запрашиваемый ресурс. При результате выполнения 200 (OK) 
...
Таким образом, МГТУ им.Н.Э.Баумана имеет id 250. С помощью метода database.getFaculties по 
